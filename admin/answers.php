...
if(isset($_GET['id']))
    $items = R::getAll('select * from answers where question = '.$_GET['id']);
else
    $items = R::getAll('select * from answers where question = 1');
?>
                ...
                <div id="tab2" class="tabContents">
                    <div id="quiz-content2">
                        ...
                        <div class="container" style="max-width:100%;direction:ltr">
                            <a href="/admin/questions.php?id=<?=$_GET['id']?>" class="btn btn-primary btn-md pull-left">Back to Question</a>
                                    ...
                                    foreach($items as $item){
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="/admin/delete_answer.php?id=<?=$item['id']?>" class="btn btn-danger btn-xs">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" action="edit_answer.php" method="post">
                                <div class="row">
                                    <div class="col-xs-12 col-sm-6 col-md-12">
                                        <div class="form-group">
                                            <input type="text" name="name" id="name" class="form-control input-sm" value="<?=$item['name']?>" />
                                            <input type="text" name="points" id="points" class="form-control input-sm" value="<?=$item['points']?>" />
        ...
        <div class="modal" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form" action="add_answer.php" method="post">
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <div class="form-group">
                                        <input type="text" name="name" id="name" class="form-control input-sm" placeholder="Question">
                                        <input type="number" name="points" id="points" class="form-control input-sm" placeholder="Points" />
                                        <input type="hidden" name="question" id="question" class="form-control input-sm" value="<?=$_GET['id']?>">
                                    </div>
                                </div>
                            </div>
                            <input type="submit" value="Add" class="btn btn-info btn-block">
