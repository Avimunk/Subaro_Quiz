...
if(isset($_GET['id']))
    $items = R::getAll('select * from questions where test = '.$_GET['id']);
else
    $items = R::getAll('select * from questions where test = 1');
?>
                ...
                <div id="tab2" class="tabContents">
                    <div id="quiz-content2">
                        ...
                        <div class="container" style="max-width:100%;direction:ltr">
                            <a href="/admin/" class="btn btn-primary btn-md pull-left">Back to Test</a>
                                    ...
                                    foreach($items as $item){
                                        ...
                                        <tr>
                                            ...
                                            <td style="color:black">
                                                <a href="/admin/answers.php?id=<?=$item['id']?>">
                                                    <?=$item['name']?>
                                                </a>
                                            </td>
                                            <td class="text-center">
                                                ...
                                                <a href="/admin/delete_question.php?id=<?=$item['id']?>" class="btn btn-danger btn-xs">
                                                    <span class="glyphicon glyphicon-remove"></span>
                                                    Del
                                                </a>
                                                <a href="/admin/answers.php?id=<?=$item['id']?>" class="btn btn-success btn-xs">
                                                    <span class="glyphicon glyphicon-loop"></span>
                                                    Show Answers
                                                </a>
                                            </td>
                                        </tr>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form role="form" action="edit_question.php" method="post">
                                <div class="row">
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-6 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="test" id="name" class="form-control input-sm" value="<?=$_GET['id']?>">
                                    </div>
                                </div>
                            </div>
                            <input type="submit" value="Add" class="btn btn-info btn-block">
